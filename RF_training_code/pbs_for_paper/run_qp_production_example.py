...
flag_dict['do_fall_tend'] = True
flag_dict['do_qp_as_var'] = True # If I want to run the simulation with qp as a prognostic parameter.
...
flag_dict['rad_level'] = 26 #Should be 0 if no radiation should be used in hte RF
...
flag_dict['resolution'] = 16 #Usually true
...
input_vert_vars = ['Tin','qin','qpin','latin'] #Dependent on the scenario we chose to model. This should give some flexibility to our coding.
output_vert_vars = ['Tout','qout','qpout']
input_vert_dim = [48,48,48,1] #Dependent on the scenario we chose to model. This should give some flexibility to our coding.
output_vert_dim = [48,48,48]
