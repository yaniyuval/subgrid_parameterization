...
flag_dict['do_ver_wind_input'] = True
...
input_vert_vars = ['Tin','qin','uin','vin_minusSH','win','surf_wind'] #Dependent on the scenario we chose to model. This should give some flexibility to our coding.
output_vert_vars = ['u_corr', 'v_corr','w_corr']
input_vert_dim = [26,26,26,26,26,1] #Dependent on the scenario we chose to model. This should give some flexibility to our coding.
output_vert_dim = [26,26,26]
