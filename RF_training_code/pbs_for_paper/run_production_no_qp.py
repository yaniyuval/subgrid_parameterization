...
input_vert_vars = ['Tin','qin','latin'] #Dependent on the scenario we chose to model. This should give some flexibility to our coding.
output_vert_vars = ['Tout','qout']
input_vert_dim = [48,48,1] #Dependent on the scenario we chose to model. This should give some flexibility to our coding.
